	...
	public MenuItemDaoCollectionImpl() {
		if (menuItemList == null) {
			try {
				...
				menuItemList.add(new MenuItem(0000001, "Sandwich", 99.00f,
				...
				menuItemList.add(new MenuItem(0000003, "Pizza", 149.00f, true,
						...
						false));
				menuItemList.add(new MenuItem(0000004, "French Fries", 57.00f,
						false, DateUtil.convertToDate("02/07/2017"),
						"Starters", true));
				menuItemList.add(new MenuItem(0000005, "Chocolate Brownie",
						32.00f, true, DateUtil.convertToDate("02/11/2022"),
						"Dessert", true));
				menuItemList.add(new MenuItem(0000006, "Chocolate ", 32.00f,
						true, DateUtil.convertToDate("12/11/2019"), "Dessert",
						false));
